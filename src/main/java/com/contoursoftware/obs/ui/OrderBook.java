...
import main.java.com.contoursoftware.obs.db.order.Dto.OrderDto;
import main.java.com.contoursoftware.obs.service.impl.CustomerService;
import main.java.com.contoursoftware.obs.service.impl.OrderService;

public class OrderBook implements GenericController<OrderDto> {
	
	OrderService orderService=new OrderService();

	@Override
	public void performAction(OrderDto obj) {
